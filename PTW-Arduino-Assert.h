...
public:
    ...
    boolean assertApproximately(float, float, float, const char *, int);
    boolean assertApproximately(double, double, double);
    boolean assertApproximately(double, double, double, const char *);
    boolean assertApproximately(double, double, double, const char *, int);
    // BOOLEAN
    ...
    boolean assertEqual(long, long);
    boolean assertEqual(long, long, const char *);
    boolean assertEqual(long, long, const char *, int);
    ...
    boolean assertEqual(size_t, size_t);
    boolean assertEqual(size_t, size_t, const char *);
    boolean assertEqual(size_t, size_t, const char *, int);
    boolean assertEqual(unsigned long, unsigned long);
    boolean assertEqual(unsigned long, unsigned long, const char *);
    boolean assertEqual(unsigned long, unsigned long, const char *, int);
    ...
    boolean assertNotEqual(long, long);
    boolean assertNotEqual(long, long, const char *);
    boolean assertNotEqual(long, long, const char *, int);
    ...
    boolean assertNotEqual(size_t, size_t);
    boolean assertNotEqual(size_t, size_t, const char *);
    boolean assertNotEqual(size_t, size_t, const char *, int);
    boolean assertNotEqual(unsigned long, unsigned long);
    boolean assertNotEqual(unsigned long, unsigned long, const char *);
    boolean assertNotEqual(unsigned long, unsigned long, const char *, int);
    ...
    boolean assertGreaterThan(long, long);
    boolean assertGreaterThan(long, long, const char *);
    boolean assertGreaterThan(long, long, const char *, int);
    ...
    boolean assertGreaterThan(size_t, size_t);
    boolean assertGreaterThan(size_t, size_t, const char *);
    boolean assertGreaterThan(size_t, size_t, const char *, int);
    boolean assertGreaterThan(unsigned long, unsigned long);
    boolean assertGreaterThan(unsigned long, unsigned long, const char *);
    boolean assertGreaterThan(unsigned long, unsigned long, const char *, int);
    ...
    boolean assertLessThan(long, long);
    boolean assertLessThan(long, long, const char *);
    boolean assertLessThan(long, long, const char *, int);
    ...
    boolean assertLessThan(size_t, size_t);
    boolean assertLessThan(size_t, size_t, const char *);
    boolean assertLessThan(size_t, size_t, const char *, int);
    boolean assertLessThan(unsigned long, unsigned long);
    boolean assertLessThan(unsigned long, unsigned long, const char *);
    boolean assertLessThan(unsigned long, unsigned long, const char *, int);
...
private:
    ...
    void printVerboseFailMessage(long, long);
    void printVerboseFailMessage(long long, long long);
    void printVerboseFailMessage(size_t, size_t);
    void printVerboseFailMessage(String, String);
    void printVerboseFailMessage(unsigned long, unsigned long);
